...
class WebController:
    ...
    def loadIdlePage(self):
        self.driver.get(idleLoc)
    
    def loadMainPage(self):
        self.driver.get(indexloc)

    def changeVideo(self,video):
        cmd = "document.getElementById('vidmp4').src='"+video+"'"
        self.driver.execute_script(cmd)
        self.driver.execute_script("document.getElementsByTagName('video')[0].load()")
    ...
    def maskRecognized(self):
        ...
        cmd = "document.getElementById('face').style.display='none'"
        self.driver.execute_script(cmd);
        self.driver.execute_script("document.getElementById('mask').src='./checked.png'")

    
    def sanitized(self):
        self.driver.execute_script("document.getElementById('sanitize').src='checked.png'")
